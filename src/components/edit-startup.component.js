...
export default class EditStartup extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost:5000/startup/'+this.props.match.params.id)
        .then((response) =>{
            this.setState({
                username: response.data.username,
                description: response.data.description,
                evaluation: response.data.evaluation,
                founding: new Date(response.data.founding)
            })
        })
    ...
    onSubmit(e) {
        ...
        console.log(startup)
        axios.post('http://localhost:5000/startup/update'+this.props.match.params.id, startup)
    ...
    render(){
        ...
        <div>
            ...
            <form onSubmit={this.onSubmit}>
                ...
                <div className = "form-group">
                    <input type = "submit" value = "Update Startup" className="btn btn-primary" />
                </div>
            </form>
        </div>
        )
